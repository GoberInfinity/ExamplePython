...
# more complicated than that, you should use normal if and for statements

# The problem with list comprehensions is that they may create a whole new list containing
# one item for each value in the input sequence. This is fine for small inputs,
# but for large inputs this could consume significant amounts of memory and cause your program to crash.

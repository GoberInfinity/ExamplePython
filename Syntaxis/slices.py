...
# If you need all three parameters, consider doing two assignments (one to slice, another to stride)
...
# can’t afford the time or memory required for two steps, consider using islice from the itertools.
